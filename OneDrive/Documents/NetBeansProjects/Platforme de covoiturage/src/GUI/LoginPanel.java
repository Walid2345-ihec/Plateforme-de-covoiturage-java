...
public class LoginPanel extends JPanel {
    ...
    private JPanel createPassengerRegistrationCard() {
        ...
        // Reuse fields for passenger (create new instances)
        JTextField pCinField = addFormField(formPanel, "CIN *");
        JTextField pNomField = addFormField(formPanel, "Nom *");
        JTextField pPrenomField = addFormField(formPanel, "Prénom *");
        JTextField pTelField = addFormField(formPanel, "Téléphone *");
        JTextField pAnneeField = addFormField(formPanel, "Année Universitaire (ex: 2024) *");
        JTextField pAdresseField = addFormField(formPanel, "Adresse");
        JTextField pMailField = addFormField(formPanel, "Email *");
