...
public class MainFrame extends JFrame {
    ...
    /**
     * Afficher la page des notifications pour le passager courant
     */
    public void showNotificationPanel() {
        if (currentUser instanceof Passager) {
            notificationPanel.setCurrentPassagerCIN(currentUser.getCin());
            cardLayout.show(mainPanel, "NOTIFICATIONS");
        }
    }
    
    /**
     * Retourner au panel passager sans parameter (depuis la page notifications)
     */
